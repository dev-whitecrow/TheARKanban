...
export declare function buildChangeNotificationEmbed(type: 'task:created' | 'task:updated' | 'task:deleted', task: TaskFrontmatter, source: string, changes?: string[]): EmbedBuilder;
