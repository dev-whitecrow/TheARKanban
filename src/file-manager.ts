...
export async function readMeta(): Promise<KanbanMeta> {
  try {
...
export async function writeMeta(meta: KanbanMeta): Promise<void> {
 ...
 */
export async function parseTaskFile(filePath: string): Promise<Task | null> {
  try {
 ...
 */
export async function scanAllTasks(): Promise<Task[]> {
